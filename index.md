            ...
            <div class="row">
                <div class="col-lg-4 col-xl-4">
                    <div class="card-box text-center">
                         <img src="https://avatars.githubusercontent.com/u/3039851?v=4" class="rounded-circle avatar-xl img-thumbnail" alt="profile-image"><h4 class="mb-0">Johan Santri</h4><p class="text-muted">@SoftwareTester</p>
    <hr>
